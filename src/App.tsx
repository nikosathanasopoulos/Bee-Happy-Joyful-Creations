    ...
    setCart((prevCart) => {
      ...
      return [
        ...prevCart,
        {
          ...
          quantity: 1,
          image: '/src/assets/images/herbal_wax_salve_1782197007682.jpg', // uses the salve visual
          ...
          <div className="lg:col-span-6 grid grid-cols-2 gap-4">
            ...
            <div className="space-y-4">
              <div className="rounded-xl overflow-hidden border border-[#EBE7DF] bg-stone-50 aspect-square relative shadow-sm hover:shadow-md transition-shadow">
                <img
                  src="/src/assets/images/soap_spring_garden_1782198290883.jpg"
                  alt="Φυσικά Βότανα"
              ...
              <div className="rounded-xl overflow-hidden border border-[#EBE7DF] bg-stone-50 aspect-[3/4] relative shadow-sm hover:shadow-md transition-shadow">
                <img
                  src="/src/assets/images/cream_facial_hydration_1782198304461.jpg"
                  alt="Φυσικά Έλαια"
                  className="w-full h-full object-cover"
                  referrerPolicy="no-referrer"
                />
            ...
            <div className="space-y-4 pt-8">
              <div className="rounded-xl overflow-hidden border border-[#EBE7DF] bg-stone-50 aspect-[3/4] relative shadow-sm hover:shadow-md transition-shadow">
                <img
                  src="/src/assets/images/boat_soaps_1782197026244.jpg"
              ...
              <div className="rounded-xl overflow-hidden border border-[#EBE7DF] bg-stone-50 aspect-square relative shadow-sm hover:shadow-md transition-shadow">
                <img
                  src="/src/assets/images/beeswax_candles_1782197042129.jpg"
